 ...
 * @author dekteguh
 */
public class FormDaftarDSRT extends javax.swing.JPanel {
     ...
     */
    public FormDaftarDSRT(MainFrame frame, String userName) {
        ...
        try {
            ...
            for (DSRT entity : arr) {
                tableModel.addRow(
                    ...
                    entity.getNamaKrt(),
                    entity.getUsername()==null?"Belum Entri":"Sudah Entri"
                });
                i++;
            }
        } catch (Exception ex) {
    ...
    private void initComponents() {
        ...
        buttonEntriRuta = new javax.swing.JButton();
        ...
        buttonHapusEntri = new javax.swing.JButton();
        ...
        jLabel1.setText("DAFTAR DSRT YANG AKAN DIENTRI");
        ...
        tabelDSRT.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "NKS", "NURT", "Nama KRT", "Status Entri"
            }
        ) {
        ...
        buttonEntriRuta.setFont(new java.awt.Font("Lucida Grande", 1, 13)); // NOI18N
        buttonEntriRuta.setText("Entri Ruta");
        buttonEntriRuta.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                buttonEntriRutaActionPerformed(evt);
            }
        });
        ...
        buttonHapusEntri.setFont(new java.awt.Font("Lucida Grande", 1, 13)); // NOI18N
        buttonHapusEntri.setText("Hapus Entri");
        buttonHapusEntri.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                buttonHapusEntriActionPerformed(evt);
            }
        });
    ...
    private void buttonEntriRutaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonEntriRutaActionPerformed
        // TODO add your handling code here:
        ...
        DSRT dsrt = null;
        try {
            dsrt = DSRTService.getRuta(Integer.valueOf(pecah[0]), Integer.valueOf(pecah[1]), pecah[2], pecah[3], pecah[4], nurt);
        } catch (Exception ex) {
            Logger.getLogger(FormDaftarDSRT.class.getName()).log(Level.SEVERE, null, ex);
        }
        this.mainFrame.getContentScrollPane().setViewportView(new FormEntri(this.mainFrame, username, dsrt));
    }//GEN-LAST:event_buttonEntriRutaActionPerformed

    private void buttonHapusEntriActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonHapusEntriActionPerformed
        // TODO add your handling code here:
        int row = tabelDSRT.getSelectedRow();
        String kode = tabelDSRT.getValueAt(row, 0).toString();
        int nurt = Integer.valueOf(tabelDSRT.getValueAt(row, 2).toString());
        ...
        try {
            dsrt = DSRTService.getRuta(Integer.valueOf(pecah[0]), Integer.valueOf(pecah[1]), pecah[2], pecah[3], pecah[4], nurt);
            dsrt.setRealisasiPanen(0);
            dsrt.setBerhasilPanen(0);
            dsrt.setAlasanTidakBerhasilPanen(null);
            dsrt.setUbinanBersama(0);
            dsrt.setHasilUbinan(0.00);
            dsrt.setUsername(null);
            
            long result = DSRTService.updateDSRT(dsrt);
            if (result == 1) {
                JOptionPane.showMessageDialog(this, "Data entri berhasil dihapus.", "Info", JOptionPane.INFORMATION_MESSAGE);
                //loadAwal();
            } else {
                JOptionPane.showMessageDialog(this, "Data entri gagal dihapus.", "Error", JOptionPane.ERROR_MESSAGE);
            }
        } catch (Exception ex) {
            Logger.getLogger(FormDaftarDSRT.class.getName()).log(Level.SEVERE, null, ex);
        }
        this.loadTabel(pecah[0]+"-"+pecah[1]+"-"+pecah[2]+"-"+pecah[3]+"-"+pecah[4]);
    }//GEN-LAST:event_buttonHapusEntriActionPerformed
    ...
    private javax.swing.JButton buttonEntriRuta;
    private javax.swing.JButton buttonHapusEntri;
