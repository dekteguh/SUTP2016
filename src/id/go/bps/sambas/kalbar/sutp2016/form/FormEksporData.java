 ...
 * @author dekteguh
 */
public class FormEksporData extends javax.swing.JPanel {
     ...
     */
    public FormEksporData(MainFrame frame, String userName) {
    ...
    private void initComponents() {
        ...
        buttonEksporData = new javax.swing.JButton();
        ...
        jLabel1.setText("EKSPOR DATA KE EXCEL");
        jLabel1.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);

        buttonEksporData.setFont(new java.awt.Font("Lucida Grande", 1, 13)); // NOI18N
        buttonEksporData.setText("Ekspor Data");
        buttonEksporData.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                buttonEksporDataActionPerformed(evt);
            }
        });
    ...
    private void buttonEksporDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonEksporDataActionPerformed
        ...
        if (jfc.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {
            try {
                ...
                Logger.getLogger(FormEksporData.class.getName()).log(Level.SEVERE, null, ex);
            }
        } else {
            return;
        }
    ...
    }//GEN-LAST:event_buttonEksporDataActionPerformed
    ...
    private javax.swing.JButton buttonEksporData;
